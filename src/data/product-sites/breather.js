...
export const breather = {
  ...
  hero: {
    ...
    heroShot: '/breather/screenshot-timer-running-dark.png',
    heroShotAlt: 'Breather timer running a Fitness focus block with coffee, water, and break quick-log buttons',
  ...
  screenshots: [
    {
      ...
      alt: 'Breather timer idle screen with the Study category selected and daily activity rings',
      title: 'Pick a category, hit start',
      caption: 'Study, Fitness, Work, Read, or a category you create — each with its own icon and color.',
    },
    {
      src: '/breather/screenshot-timer-running-dark.png',
    ...
    {
      src: '/breather/screenshot-landscape-clock-dark.png',
